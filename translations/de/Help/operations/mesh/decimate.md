...
Reduzieren verringert die Polygonanzahl eines Meshes und erhält dabei die Gesamtform. Das ist nützlich, um sehr detaillierte Modelle zu vereinfachen, die Dateigröße zu verringern und Operationen an komplexer Geometrie zu beschleunigen.
...
2. Wenden Sie die Operation **Reduzieren** aus dem Mesh-Menü an
...
- **Ausgangs-Polygonanzahl** – Ursprüngliche Anzahl der Polygone (schreibgeschützt)
- **Zielprozentsatz** – Prozentsatz der beizubehaltenden Polygone (im Modus Prozent sichtbar)
- **Zielanzahl** – Exakte Anzahl der beizubehaltenden Polygone (im Modus Anzahl sichtbar)
- **Anzahl nach prozentualer Reduzierung** – Endgültige Polygonanzahl nach der prozentualen Reduzierung (schreibgeschützt)
- **Oberfläche beibehalten** – Projiziert die Vertices zurück auf die ursprüngliche Oberfläche für höhere Genauigkeit (langsamer, aber näher an der ursprünglichen Form)
...
- [Reparieren](repair.md) – Mesh-Probleme beheben
