...
source_lang: en
---
MatterCAD enthält alles, was Sie zum Umsetzen Ihrer Ideen brauchen – von Anfang an!
...
Mit diesen einfachen Grundkörpern und den mitgelieferten Werkzeugen können Sie alles erstellen, was Sie sich vorstellen können.
...
- Würfel  
  ...
  - **Breite:** Legt die Größe in X fest
  - **Tiefe:** Legt die Größe in Y fest
  - **Höhe:** Legt die Größe in Z fest
- Pyramide  
...
- Text  
  ...
  - **Name:** Geben Sie den Text ein, der angezeigt werden soll
  - **Schriftgröße:** Legt die Größe der Schrift fest. Sie entspricht der Größe, die ein 2D-Drucker beim Druck im gleichen Maßstab ausgeben würde.
  - **Höhe:** Legt fest, wie hoch der Text aufragen soll
...
- Zylinder  
  ...
  - **Durchmesser:** Legt die Größe quer über das Bauteil fest
  - **Höhe:** Legt die Größe in Z fest
  - **Seiten:** Legt die Anzahl der Flächen (oder Seiten) rund um das Bauteil fest
  - **Erweitert:** Öffnet die erweiterten Einstellungen für weitere Funktionen
    - **Startwinkel:** Der Winkel, bei dem die Rotation des Zylinders beginnt
    - **Endwinkel:** Der Winkel, bei dem die Rotation des Zylinders endet
    - **Durchmesser oben:** Die Größe der Oberseite des Zylinders
- Kegel  
...
- Torus  
  ...
  - **Außendurchmesser:** Legt die Größe quer über das Bauteil fest
  - **Innendurchmesser:** Legt die Größe der Innenseite des Torus fest
  - **Seiten:** Legt die Anzahl der Flächen (oder Seiten) rund um das Bauteil fest
  - **Erweitert:** Öffnet die erweiterten Einstellungen für weitere Funktionen
    - **Startwinkel:** Der Winkel, bei dem die Rotation des Zylinders beginnt
    - **Endwinkel:** Der Winkel, bei dem die Rotation des Zylinders endet
    - **Ringseiten:** Die Anzahl der Seiten rund um den Ringquerschnitt
    - **Ring-Phasenwinkel:** Der Winkel, bei dem die Ringseiten beginnen
- Ring  
...
- Kugel  
  ...
  - **Erweitert:** Öffnet die erweiterten Einstellungen für weitere Funktionen
    - **Startwinkel:** Der Winkel, bei dem die Rotation des Zylinders beginnt
    - **Endwinkel:** Der Winkel, bei dem die Rotation des Zylinders endet
    - **Breitengrad-Seiten:** Die Anzahl der Seiten von oben nach unten
- Halbkugel  
  ...
  - **Durchmesser:** Legt die Größe quer über das Bauteil fest
  - **Längengrad-Seiten:** Legt die Anzahl der Flächen (oder Seiten) rund um das Bauteil fest
  - **Breitengrad-Seiten:** Die Anzahl der Seiten von oben nach unten
- [Bildkonverter](image-converter.md)  
  ...
  - Mit dem Bildkonverter können Sie aus Bildern vollständige Extrusionen erstellen
  - Sie können Bilder auch direkt auf das Druckbett ziehen und mit den Werkzeugen aus dem Überlaufmenü alle Funktionen des Bildkonverters (und mehr) nutzen.
