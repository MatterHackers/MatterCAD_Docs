...
1. Add the **Measure Tool** from the tools menu
2. Drag the measurement points to the locations you want to measure between
3. The distance is displayed in the viewport

## Tips

- Use this to verify dimensions before exporting for 3D printing
- The Measure Tool displays the straight-line distance between the two control points
- You can leave the Measure Tool in your design while you work and remove it before exporting
